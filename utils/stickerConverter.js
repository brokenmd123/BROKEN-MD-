...
const addStickerMetadata = async (stickerBuffer, packname, author) => {
  try {
    ...
    const metadata = {
      'sticker-pack-name': packname || '𝑂𝑃𝑇𝐼𝑀𝑈𝑆 𝑃𝑅𝐼𝑀𝐸',
      'sticker-pack-publisher': author || '𝑂𝑃𝑇𝐼𝑀𝑈𝑆 𝑃𝑅𝐼𝑀𝐸'
    };
 ...
 */
const createSticker = async (mediaBuffer, isVideo = false, packname = '𝑂𝑃𝑇𝐼𝑀𝑈𝑆 𝑃𝑅𝐼𝑀𝐸', author = 'MAJESTY👑') => {
  try {
